...
namespace Master.Database.Management.ServerlessApi.Mediators.Internal.Fixes.Templates
{
  internal class FixTemplateMediator : IFixTemplateMediator
  {
    ...
    public async Task<IEnumerable<FixTemplateDto>> GetManyAsync(CancellationToken cancellationToken, Guid? userId = null, string[] tags = null, FixTemplateStatus? status = null, string typeName = null, string categoryName = null, long? minTimestampUtc = null, long? maxTimestampUtc = null)
    {
      cancellationToken.ThrowIfCancellationRequested();

      var result = await _requestMdmDalFactory.RequestMdmFixTemplateDal().GetManyAsync(cancellationToken, userId, tags, status, typeName, categoryName, minTimestampUtc, maxTimestampUtc);

      return result;
    }

    public async Task<PagedModelCollectionDto<FixTemplateDto>> GetManyByPageAsync(int currentPage, CancellationToken cancellationToken, int? pageSize = null, Guid? userId = null, string[] tags = null, FixTemplateStatus? status = null, string typeName = null, string categoryName = null, long? minTimestampUtc = null, long? maxTimestampUtc = null)
    {
      cancellationToken.ThrowIfCancellationRequested();
      
      var result = await _requestMdmDalFactory.RequestMdmFixTemplateDal().GetManyByPageAsync(currentPage, cancellationToken, pageSize, userId, tags, status, typeName, categoryName, minTimestampUtc, maxTimestampUtc);
