...
{
  public class GetPagedFixTemplates
  {
    private readonly IRequestMediatorFactory _requestMediatorFactory;

    public GetPagedFixTemplates(IRequestMediatorFactory requestMediatorFactory)
    {
    ...
    [FunctionName("GetPagedFixTemplates")]
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "fixTemplates/{pageNumber}")]
                                          HttpRequestMessage httpRequest,
                                          CancellationToken cancellationToken,
                                          int pageNumber)
    {
      return await GetPagedFixTemplatesByUserIdAsync(pageNumber, httpRequest, cancellationToken);
    }

    public async Task<IActionResult> GetPagedFixTemplatesByUserIdAsync(int pageNumber, HttpRequestMessage httpRequest, CancellationToken cancellationToken)
    {
