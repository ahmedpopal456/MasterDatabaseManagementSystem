...
{
  public class GetFixTemplates
  {
    private readonly IRequestMediatorFactory _requestMediatorFactory;

    public GetFixTemplates(IRequestMediatorFactory requestMediatorFactory)
    {
    ...
    public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "fixTemplates")]
                                          HttpRequestMessage httpRequest,
                                          CancellationToken cancellationToken)
    {
      return await GetFixTemplatesByUserIdAsync(httpRequest, cancellationToken);
    }

    public async Task<IActionResult> GetFixTemplatesByUserIdAsync(HttpRequestMessage httpRequest, CancellationToken cancellationToken)
    {
