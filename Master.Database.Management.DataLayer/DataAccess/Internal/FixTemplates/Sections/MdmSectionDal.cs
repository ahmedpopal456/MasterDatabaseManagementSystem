...
namespace Master.Database.Management.DataLayer.DataAccess.Internal.FixTemplates.Sections
{
  internal class MdmSectionDal : IMdmSectionDal
  {
    ...
    public async Task<SectionDto> CreateAsync(SectionCreateRequestDto sectionCreateRequestDto, CancellationToken cancellationToken)
    {
      ...
      {
        throw new ArgumentNullException($"{nameof(CreateAsync)} expects a value for {nameof(sectionCreateRequestDto)}... null argument was provided");
      }
    ...
    public async Task<MdmResponseDto<List<SectionDto>>> GetOrCreateManyAsync(IEnumerable<SectionCreateRequestDto> sectionCreateRequestDtos, CancellationToken cancellationToken)
    {
      ...
      {
        throw new ArgumentNullException($"{nameof(GetOrCreateManyAsync)} excpects a value for {nameof(IEnumerable<SectionCreateRequestDto>)}... null argument was provided");
      }
    ...
    public async Task<SectionDto> GetByIdAsync(Guid id, CancellationToken cancellationToken)
    {
      ...
      {
        throw new ArgumentNullException($"{nameof(MdmSectionDal)} expects a value for {nameof(Guid)}... null argument was provided");
      }
