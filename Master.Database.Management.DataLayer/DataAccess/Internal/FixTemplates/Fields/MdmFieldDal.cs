...
namespace Master.Database.Management.DataLayer.DataAccess.Internal.FixTemplates.Fields
{
  internal class MdmFieldDal : IMdmFieldDal
  {
    ...
    public async Task<FieldDto> CreateAsync(FieldCreateRequestDto fieldCreateRequestDto, CancellationToken cancellationToken)
    {
      ...
      {
        throw new ArgumentNullException($"{nameof(CreateAsync)} expects a value for {nameof(fieldCreateRequestDto)}... null argument was provided");
      }
    ...
    public async Task<MdmResponseDto<List<FieldDto>>> GetOrCreateManyAsync(IEnumerable<FieldCreateRequestDto> fieldCreateRequestDtos, CancellationToken cancellationToken)
    {
      ...
      {
        throw new ArgumentNullException($"{nameof(GetOrCreateManyAsync)} expects a value for {nameof(IEnumerable<FieldCreateRequestDto>)}... null argument was provided");
      }
