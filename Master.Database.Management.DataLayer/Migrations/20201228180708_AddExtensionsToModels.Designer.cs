...
namespace Master.Database.Management.DataLayer.Migrations
{
    ...
    [Migration("20201228180708_AddExtensionsToModels")]
    partial class AddExtensionsToModels
    {
            ...
            modelBuilder.Entity("Master.Database.Management.DataLayer.Models.FixTemplates.WeakEntities.FixTemplateSectionField", b =>
                {
                    ...
                    b.Property<Guid?>("FixTemplateSectionId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FixTemplateSectionId1");
            ...
            modelBuilder.Entity("Master.Database.Management.DataLayer.Models.FixTemplates.WeakEntities.FixTemplateTag", b =>
                {
                    ...
                    b.Property<Guid?>("FixTemplateId1")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("FixTemplateId", "Name");

                    b.HasIndex("FixTemplateId1");
            ...
            modelBuilder.Entity("Master.Database.Management.DataLayer.Models.FixTemplates.WeakEntities.FixTemplateSectionField", b =>
                {
                    ...
                    b.HasOne("Master.Database.Management.DataLayer.Models.FixTemplates.WeakEntities.FixTemplateSection", null)
                        .WithMany("FixTemplateSectionFields")
                        .HasForeignKey("FixTemplateSectionId1");
                });
            ...
            modelBuilder.Entity("Master.Database.Management.DataLayer.Models.FixTemplates.WeakEntities.FixTemplateTag", b =>
                {
                    ...
                    b.HasOne("Master.Database.Management.DataLayer.Models.FixTemplates.FixTemplate", null)
                        .WithMany("Tags")
                        .HasForeignKey("FixTemplateId1");
                });
